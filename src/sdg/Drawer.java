...
public class Drawer {
    ...
    public Image getROYGBIV(int x,int y){
        BufferedImage roygbiv = new BufferedImage(x,y,BufferedImage.TYPE_INT_RGB);
        int w = y/7;
        Graphics2D graph = roygbiv.createGraphics();
        graph.setColor(Color.RED);
        graph.fillRect(0, 0, w, y);
        graph.setColor(new Color(255,150,0));
        graph.fillRect(w, 0, w, y);
        graph.setColor(Color.YELLOW);
        graph.fillRect(w*2, 0, w, y);
        graph.setColor(Color.GREEN);
        graph.fillRect(w*3, 0, w, y);
        graph.setColor(Color.BLUE);
        graph.fillRect(w*4, 0, w, y);
        graph.setColor(new Color(255,0,255));
        graph.fillRect(w*5, 0, w, y);
        graph.setColor(new Color(50,0,100));
        graph.fillRect(w*6, 0, w, y);
        return roygbiv;
